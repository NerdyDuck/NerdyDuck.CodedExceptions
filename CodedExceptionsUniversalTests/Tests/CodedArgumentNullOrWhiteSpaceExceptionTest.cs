#region Copyright
/*******************************************************************************
 * <copyright file="CodedArgumentNullOrWhiteSpaceExceptionTest.cs" owner="Daniel Kopp">
 ...
 * </assembly>
 * <file name="CodedArgumentNullOrWhiteSpaceExceptionTest.cs" date="2015-10-23">
 * Contains test methods to test the
 * NerdyDuck.CodedExceptions.CodedArgumentNullOrWhiteSpaceException class.
 * </file>
 ******************************************************************************/
#endregion
...
#endif
	[TestClass]
	public class CodedArgumentNullOrWhiteSpaceExceptionTest
	{
		#region Constructors
		[TestMethod]
		...
		public void Ctor_String_Success()
		{
			try
			{
				throw new CodedArgumentNullOrWhiteSpaceException(Constants.ParamName);
			}
			catch (CodedArgumentNullOrWhiteSpaceException ex)
			{
				Assert.AreEqual(Constants.COR_E_ARGUMENT, ex.HResult);
		...
		public void Ctor_StringException_Success()
		{
			try
			{
				...
				{
					throw new CodedArgumentNullOrWhiteSpaceException(Constants.TestMessage, ex);
				}
			}
			catch (CodedArgumentNullOrWhiteSpaceException ex)
			{
		...
		public void Ctor_StringString_Success()
		{
			try
			{
				throw new CodedArgumentNullOrWhiteSpaceException(Constants.ParamName, Constants.TestMessage);
			}
			catch (CodedArgumentNullOrWhiteSpaceException ex)
			{
				Assert.AreEqual(Constants.COR_E_ARGUMENT, ex.HResult);
		...
		public void Ctor_Int32_Success()
		{
			try
			{
				throw new CodedArgumentNullOrWhiteSpaceException(Constants.CustomHResult);
			}
			catch (CodedArgumentNullOrWhiteSpaceException ex)
			{
		...
		public void Ctor_IntString_Success()
		{
			try
			{
				throw new CodedArgumentNullOrWhiteSpaceException(Constants.CustomHResult, Constants.ParamName);
			}
			catch (CodedArgumentNullOrWhiteSpaceException ex)
			{
				Assert.AreEqual(Constants.CustomHResult, ex.HResult);
		...
		public void Ctor_IntStringException_Success()
		{
			try
			{
				...
				{
					throw new CodedArgumentNullOrWhiteSpaceException(Constants.CustomHResult, Constants.TestMessage, ex);
				}
			}
			catch (CodedArgumentNullOrWhiteSpaceException ex)
			{
		...
		public void Ctor_IntStringString_Success()
		{
			try
			{
				throw new CodedArgumentNullOrWhiteSpaceException(Constants.CustomHResult, Constants.ParamName, Constants.TestMessage);
			}
			catch (CodedArgumentNullOrWhiteSpaceException ex)
			{
				Assert.AreEqual(Constants.CustomHResult, ex.HResult);
		...
		public void ToString_Success()
		{
			...
			catch (Exception ex)
			{
				...
				StringAssert.StartsWith(str, string.Format("{0}: ({1}) {2}", typeof(CodedArgumentNullOrWhiteSpaceException).FullName, Constants.CustomHResultString, Constants.TestMessage));
