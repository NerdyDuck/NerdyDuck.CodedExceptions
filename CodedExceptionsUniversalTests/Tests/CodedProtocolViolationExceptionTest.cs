#region Copyright
/*******************************************************************************
 * <copyright file="CodedProtocolViolationExceptionTest.cs" owner="Daniel Kopp">
 ...
 * </assembly>
 * <file name="CodedProtocolViolationExceptionTest.cs" date="2015-08-12">
 * Contains test methods to test the
 * NerdyDuck.CodedExceptions.CodedProtocolViolationException class.
 * </file>
 ******************************************************************************/
#endregion
...
#endif
	[TestClass]
	public class CodedProtocolViolationExceptionTest
	{
		#region Constructors
		[TestMethod]
		...
		public void Ctor_String_Success()
		{
			try
			{
				throw new CodedProtocolViolationException(Constants.TestMessage);
			}
			catch (CodedProtocolViolationException ex)
			{
				Assert.AreEqual(Constants.COR_E_INVALIDOPERATION, ex.HResult);
		...
		public void Ctor_Int32_Success()
		{
			try
			{
				throw new CodedProtocolViolationException(Constants.CustomHResult);
			}
			catch (CodedProtocolViolationException ex)
			{
		...
		public void Ctor_IntString_Success()
		{
			try
			{
				throw new CodedProtocolViolationException(Constants.CustomHResult, Constants.TestMessage);
			}
			catch (CodedProtocolViolationException ex)
			{
				Assert.AreEqual(Constants.CustomHResult, ex.HResult);
		...
		public void ToString_Success()
		{
			...
			catch (Exception ex)
			{
				...
				StringAssert.StartsWith(str, string.Format("{0}: ({1}) {2}", typeof(CodedProtocolViolationException).FullName, Constants.CustomHResultString, Constants.TestMessage));
