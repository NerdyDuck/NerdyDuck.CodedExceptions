 ...
 * it already exists on the disk. This exception provides constructors to set
 * custom HResult values.
 * </file>
 ******************************************************************************/
#endregion
...
namespace NerdyDuck.CodedExceptions.IO
{
	...
	public class CodedFileExistsException : System.IO.IOException
	{
		...
		private static string CreateMessage(string message, string fileName)
		{
			...
			if (fileName == null)
			{
				return Properties.Resources.CodedFileExistsException_Message;
			}
			return string.Format(Properties.Resources.CodedFileExistsException_MessageFile, fileName);
		}
		#endregion
	}
}
