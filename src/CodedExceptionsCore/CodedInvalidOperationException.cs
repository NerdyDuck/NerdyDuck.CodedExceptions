#region Copyright
/*******************************************************************************
 * <copyright file="CodedInvalidOperationException.cs" owner="Daniel Kopp">
 ...
 * </assembly>
 * <file name="CodedInvalidOperationException.cs" date="2015-08-06">
 * The exception that is thrown when a method call is invalid for the object's
 * current state. This exception provides constructors to set custom HResult
 * values.
 * </file>
 ******************************************************************************/
#endregion
...
namespace NerdyDuck.CodedExceptions
{
	...
	[CodedException]
	[ComVisible(true)]
	public class CodedInvalidOperationException : System.InvalidOperationException
	{
		#region Constructors
		/// <summary>
		...
		protected CodedInvalidOperationException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			: base(info, context)
		{
		}
#endif
