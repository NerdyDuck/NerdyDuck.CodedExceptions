#region Copyright
/*******************************************************************************
 * <copyright file="CodedArgumentNullException.cs" owner="Daniel Kopp">
 ...
 * </assembly>
 * <file name="CodedArgumentNullException.cs" date="2015-08-06">
...
namespace NerdyDuck.CodedExceptions
{
	...
	[CodedException]
	[ComVisible(true)]
	public class CodedArgumentNullException : System.ArgumentNullException
	{
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="CodedArgumentNullException"/> class.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CodedArgumentNullException"/> class with the name of the parameter that causes this exception.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CodedArgumentNullException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CodedArgumentNullException"/> class with a specified error message and the name of the parameter that causes this exception.
		/// </summary>
		...
		protected CodedArgumentNullException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			: base(info, context)
		{
		}
#endif
