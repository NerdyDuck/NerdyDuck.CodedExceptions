 ...
 * <file name="Resources.Designer.cs" date="2016-08-02">
...
namespace NerdyDuck.CodedExceptions.Properties
{
	...
	internal static class Resources
	{
		...
		/// <summary>
		/// Gets a localized string similar to "A socket error occurred.".
		/// </summary>
		internal static string CodedSocketException_Message
		{
			get { return GetResource("CodedSocketException_Message"); }
		}

		/// <summary>
		/// Gets a localized string similar to "(Socket error: {0} ({0:d}))".
		/// </summary>
		internal static string CodedSocketException_ToString_SocketErrorCode
		{
			get { return GetResource("CodedSocketException_ToString_SocketErrorCode"); }
		}
		...
		/// <summary>
		/// Gets a localized string similar to "Not enough free space in data storage.".
		/// </summary>
		internal static string InsufficientStorageSpaceException_Message
		{
			get { return GetResource("InsufficientStorageSpaceException_Message"); }
		}

		/// <summary>
		/// Gets a localized string similar to "Not enough free space in data storage "{0}".".
		/// </summary>
		internal static string InsufficientStorageSpaceException_MessagePath
		{
			get { return GetResource("InsufficientStorageSpaceException_MessagePath"); }
		}
		...
		internal static System.Resources.ResourceManager ResourceManager
		{
			get
			{
				...
				{
					System.Resources.ResourceManager temp = new System.Resources.ResourceManager("NerdyDuck.CodedExceptions.Properties.Resources", typeof(Resources).GetTypeInfo().Assembly);
