...
public class CodedArgumentNullOrEmptyException : ArgumentException
{
	...
	public CodedArgumentNullOrEmptyException()
		: base(SR.CodedArgumentNullOrEmptyException_Message)
	{
	}
	...
	public CodedArgumentNullOrEmptyException(string? paramName)
		: base(SR.CodedArgumentNullOrEmptyException_Message, paramName)
	{
	}
	...
	public CodedArgumentNullOrEmptyException(int hresult)
		: base(SR.CodedArgumentNullOrEmptyException_Message) => HResult = hresult;
	...
	public CodedArgumentNullOrEmptyException(int hresult, string? paramName)
		: base(SR.CodedArgumentNullOrEmptyException_Message, paramName) => HResult = hresult;
...
#pragma warning disable CS0109 // Member does not hide an inherited member; new keyword is not required
...
#endif
	{
		...
		{
			throw new CodedArgumentNullOrEmptyException(paramName);
		}
	}
...
#endif
	{
		if (string.IsNullOrEmpty(argument))
		{
			throw new CodedArgumentNullOrEmptyException(hresult, paramName);
		}
	}
