@ECHO OFF
REM make_certs.bat
REM Creates a PFX file to sign the Universal Windows Unit Test App, if the file does not exist.
REM Create a strong name key file (.snk) in the solution folder to sign all assemblies, if the file does not exist.
REM Copyright 2015 Daniel Kopp
REM Licensed under the Apache License, Version 2.0

SET PfxPath="CodedExceptionsUniversalTests\CodedExceptionsUniversalTests_TemporaryKey.pfx"
